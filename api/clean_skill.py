...
def clean_skill(skill, remove_stopwords = True):
    ...
    alias_string["wireframe"] = [ "wireframes", "wire frame", "wire frames", "wire-frame", "wirefram", "wire fram", "wireframing" ]
    alias_string["aws"] = [ "amazon web service", ]
    alias_string["OOP"] = [  "object oriented", "object oriented programming", ]
    alias_string["osx"] = [ "mac os x", "os x" ]
    alias_string["OOD"] = [ "object oriented design", ]
    alias_string["OLAP"] = [ "online analytical processing",  ]
    alias_string["Ecommerce"] = [ "e commerce",  ]
    alias_string["consultant"] = [ "consulting",  ]
    alias_string["ux"] = [ "user experience", "web user experience design", "user experience design", "ux designer", "user experience/ux" ]
    alias_string["html5"] = [ "html 5",  ]
    alias_string["bigdata"] = [ "big data",  ]
    alias_string["j2ee"] = [ "jee",  ]
    alias_string["senior"] = [ "sr" ]
    alias_string["qa"] = [ "quality",  ]
